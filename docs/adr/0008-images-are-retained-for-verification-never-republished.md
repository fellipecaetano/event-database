...
Documents showed that reasoning to be incomplete. When a screenshot or an Event flyer is the
...
A flyer for an Event is frequently the only carrier of its details *and* the most
